  ...
  const menuItems: MenuItemDef[] = [
    {
      ...
      type: 'item',
      label: 'Run Mission',
      icon: <FontAwesomeIcon icon={faPlay} className={contextMenuIcon} />,
      disabled: loading,
    ...
    { id: 'sep1', type: 'separator' },
    {
      ...
      submenuItems: [
        ...
        },
        {
          ...
          disabled: loading,
          onClick: () => {
            void Util.runCommand(`cursor ${JSON.stringify(mission.project_path ?? '')}`)
            onClose()
          },
        },
        {
          ...
          icon: <FontAwesomeIcon icon={faFolderOpen} className={contextMenuIcon} />,
          onClick: () => {
            void Util.runCommand(`explorer ${JSON.stringify(mission.project_path ?? '')}`)
            onClose()
          },
        },
      ],
    ...
    { id: 'sep2', type: 'separator' },
    {
      ...
      type: 'item',
      label: 'Manage Mods',
      icon: <FontAwesomeIcon icon={faList} className={contextMenuIcon} />,
      disabled: loading,
      onClick: () => { onMods(); onClose() },
    },
    {
      id: 'build',
      type: 'submenu',
      label: 'Build & Version',
      icon: <FontAwesomeIcon icon={faCodeBranch} className={contextMenuIcon} />,
      disabled: !hasProjectPath || loading,
      submenuItems: [
        {
          id: 'pbo',
          label: 'Build PBO',
          icon: <FontAwesomeIcon icon={faArchive} className={contextMenuIcon} />,
          onClick: () => { onPbo(); onClose() },
        },
        {
          id: 'github',
          label: 'Git History',
          icon: <FontAwesomeIcon icon={faGithub} className={contextMenuIcon} />,
          disabled: !mission.github_integration,
          onClick: () => { onGithub(); onClose() },
        },
      ],
    },
